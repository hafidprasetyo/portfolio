...
<head>
    ...
    <title>Hafid Arief Prasetyo</title>
    <link rel="icon" href="{{ asset('image/Logoo.png')}}"/>
  ...
  <nav class="bg-transparent px-2 sm:px-4 py-2.5  fixed w-full z-20 top-0 left-0 ">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        <a class="flex items-center">
            <img src="{{ asset('image/Logo.png')}}" class="h-10 mr-3 sm:ml-3 mt-2" alt="Logo Hafid" />
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul class="flex flex-col p-4 mt-4 bg-transparent md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="#home" class="block py-2 mt-2 pl-3 pr-4 font-navbar text-white rounded  hover:bg-blue-600 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" >Home</a>
            </li>
            <li>
              <a href="#about" class="block py-2 mt-2 pl-3 pr-4 font-navbar text-white rounded  hover:bg-blue-600 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">About</a>
            </li>
            <li>
              <a href="#service" class="block py-2 mt-2 pl-3 pr-4 font-navbar text-white rounded hover:bg-blue-600  md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Services</a>
            </li>
            <li>
              <a href="#project" class="block py-2 mt-2 pl-3 pr-4 font-navbar text-white rounded hover:bg-blue-600 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Project</a>
            </li>
            <li>
              <a href="#blog" class="block py-2 mt-2 pl-3 pr-4 font-navbar text-white rounded hover:bg-blue-600  md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700  md:dark:hover:bg-transparent">Blog</a>
            </li>
          </ul>
        </div>
    </div>
...
<!--Bagian Judul-->
  <section id="home">
  <div class="container-full bg-gradient-to-t from-gradasi2 to-gradasi1">
    <h1 class="text-center pt-20 text-judul font-navbar font-bold text-judull sm:text-lg"> I'm Hafid Arief Prasetyo</h1>
...
<!--Bagian Social Media-->
  <div class="container-full bg-gradasi3">
        <ul class="flex flex-wrap justify-center p-4">
          <li>
            <a href="https://www.linkedin.com/in/hafidprasetyo/" class="block md:mr-56 pl-5 pt-1 font-medium text-lg md:text-holdd text-judul">Linkedin</a>
          </li>
          <li>
            <a href="https://www.instagram.com/hafidprasetyo_/" class="block pt-1 pr-5 pl-5 font-medium text-lg md:text-holdd text-judul">Instagram</a>
          </li>
          <li>
            <a href="https://github.com/hafidprasetyo" class="block md:ml-56 pl-5 pt-1 font-medium text-lg md:text-holdd  text-judul">Github</a>
          </li>
        </ul>
  </div>
<!--Bagian Introduce My Self-->
  <section id="about">
    <div class="container-full bg-gradient-to-t from-gradasi2 to-gradasi7 justify-between ">
          <ul class="flex flex-wrap justify-center p-4 md:flex-wrap-reverse ">
            ...
            <li class="mt-7 mx-auto">
              ...
              <p class="block text-center md:text-justify text-white font-bold font-navbar text-hold mb-5">My name is Hafid Arief Prasetyo. I'm a passionate web developer.<br> I am a student at the Telkom Purwokerto Institute of Technology</p>
              ...
              <a href="CV.pdf"><button type="button" class="focus:outline-none mt-3 text-gradasi5 bg-gradasi6 font-semibold rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 hover:bg-zinc-600">Donwload CV</button></a>
            </li>
    </div>
  </section>
<!--Bagian Keahlian-->
  <div class="container-full bg-gradasi3">
        <ul class="flex flex-wrap justify-center p-2 md:flex-wrap-reverse dark:border-gray-700">
          <li>
            <a class="block py-2 pl-3 pr-4 font-medium  text-lg md:text-holdd text-judul">HTML</a>
          </li>
          <li>
            <a  class="block py-2 pl-3 pr-4 font-medium text-lg md:text-holdd text-judul">CSS</a>
          </li>
          <li>
            <a  class="block py-2 pl-3 pr-4 font-medium  text-lg md:text-holdd  text-judul">Java Script</a>
          </li>
          <li>
            <a  class="block py-2 pl-3 pr-4 font-medium  text-lg md:text-holdd  text-judul">Boostrap</a>
          </li>
          <li>
            <a  class="block py-2 pl-3 pr-4 font-medium  text-lg md:text-holdd  text-judul">Laravel</a>
          </li>
          <li>
            <a class="block py-2 pl-3 pr-4 font-medium  text-lg md:text-holdd  text-judul">PHP</a>
          </li>
          <li>
            <a class="block py-2 pl-3 pr-4 font-medium  text-lg md:text-holdd  text-judul">Tailwind CSS</a>
          </li>
        </ul>
  </div>
<!--Bagian Pelayanan-->
  <section id="service">
    <div class="container-full bg-gradient-to-t from-gradasi2 to-gradasi7">
    <ul class="flex flex-wrap justify-center p-2 md:flex-wrap-reverse dark:border-gray-700">
...
<!--Bagian Project-->
  <section id="project" >
    <div class="container-full bg-gradient-to-t from-gradasi2 to-gradasi7">
    <h1 class="text-center font-bold text-judull text-judul font-navbar pt-10">Project</h1>
    ...
    <ul class="flex flex-wrap justify-center p-2 dark:border-gray-700">
      <li class="mx-auto mt-8 mb-5">
          <img src="{{ asset('image/Layanansurat.png')}}" class="mx-auto h-40 md:h-full" alt="Logo Web Design">
      </li>
      <li class="mt-3 mb-6 md:mt-8 mx-auto">
        <img src="{{ asset('image/Layananpertanian.png')}}" class="mx-auto h-40 md:h-full" alt="Logo Development">
      </li>
    </ul>
    </div>
  </section>
...
<!--Bagian Blog-->
 ...
 <h1 class="text-center font-bold text-judull text-judul font-navbar pt-10">Blog</h1>

 <ul class="flex flex-wrap justify-center p-8 ">
    <div class="max-w-md p-9 mx-auto mt-3 mb-5 bg-transparent ">
    <li>
        <img src="{{ asset('image/HMIF.png')}}" class="h-56 md:h-72 mx-auto" alt="Logo Web Design">
    ...
    <li>
      <img src="{{ asset('image/KKNT.png')}}" class="h-56 md:h-72 mx-auto" alt="Logo Development">
    ...
    <li>
    <img src="{{ asset('image/Innovillagetegal.png')}}" class="h-56 md:h-72 mx-auto" alt="Logo Development">
      <h1 class="text-center text-pelayanan font-navbar font-bold text-hold mt-5">Innovillage 2022 by Telkom Indonesia</h1>
 ...
 <h2 class="text-white text-center font-bold text-navbar pb-11">Let's Start by Saying Hello!</h2>
 </div>
<!--Bagian Footer-->
 <div class="container-full bg-gradient-to-t from-gradasi7 to-gradasi2 ">
        <ul class="flex flex-wrap justify-center p-2">
          <li>
            <a class="block pt-3 pb-3 text-center font-normal text-hold text-judul">Create By Hafid | All Right Reserved</a>
          </li>
        </ul>
        <br>
  </div>
